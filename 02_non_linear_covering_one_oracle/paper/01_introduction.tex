...
\begin{wrapfigure}{r}{0.4\textwidth}
    \vspace{-1cm}
    \begin{center}
       \includegraphics[width=0.7\linewidth]{../../01_covering_multiple_experts/paper/Img/consistency_robustness.png}
    \end{center}
    \vspace{-0.6cm}
...
\paragraph{Energy Minimization in Scheduling.}
...
\paragraph{Submodular Minimization.}
