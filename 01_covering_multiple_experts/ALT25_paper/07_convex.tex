...
\begin{figure}[ht]
    ...
    \label{fig:reformulation-convex}
\end{figure}
...
\subsection{Non-linear objective function properties} \label{sec:f-properties-convex}
